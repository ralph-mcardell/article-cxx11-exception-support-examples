...
$(BUILD_DIR)/$(CATCH_CLAUSE_AROUND).o: $(CATCH_CLAUSE_AROUND).cpp $(COMMON_CATCH_API_HDR)

$(BUILD_DIR)/$(CATCH_CLAUSE_MOTIVATING).o: $(CATCH_CLAUSE_MOTIVATING).cpp $(COMMON_CATCH_API_HDR)

$(BUILD_DIR)/$(CATCH_CLAUSE).o: $(CATCH_CLAUSE).cpp $(COMMON_CATCH_API_HDR)

$(COMMON_CATCH_MAIN_OBJ): $(COMMON_CATCH_MAIN).c $(COMMON_CATCH_API_HDR)
	$(MK_TARGET_DIR)
	$(CC) $(CFLAGS) -c $< -o $@
