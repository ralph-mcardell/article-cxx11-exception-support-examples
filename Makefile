...
CUSTOM_ERRC_APPENGINE_ERROR := appengine_error
CUSTOM_ERRC_APPENGINE_ERROR_SRC := $(CUSTOM_ERRC_BITS_SRC_DIR_FULL)/$(CUSTOM_ERRC_APPENGINE_ERROR).cpp
CUSTOM_ERRC_APPENGINE_ERROR_HDR := $(CUSTOM_ERRC_BITS_SRC_DIR_FULL)/$(CUSTOM_ERRC_APPENGINE_ERROR).h
CUSTOM_ERRC_APPENGINE_ERROR_OBJ := $(BUILD_DIR)/$(CUSTOM_ERRC_APPENGINE_ERROR).o
CUSTOM_ERRC_RENDERER_ERROR := renderer_error
CUSTOM_ERRC_RENDERER_ERROR_SRC := $(CUSTOM_ERRC_BITS_SRC_DIR_FULL)/$(CUSTOM_ERRC_RENDERER_ERROR).cpp
CUSTOM_ERRC_RENDERER_ERROR_HDR := $(CUSTOM_ERRC_BITS_SRC_DIR_FULL)/$(CUSTOM_ERRC_RENDERER_ERROR).h
CUSTOM_ERRC_RENDERER_ERROR_OBJ := $(BUILD_DIR)/$(CUSTOM_ERRC_RENDERER_ERROR).o

CUSTOM_ERRC_API := the_game_api
CUSTOM_ERRC_API_SRC := $(CUSTOM_ERRC_BITS_SRC_DIR_FULL)/$(CUSTOM_ERRC_API).cpp
CUSTOM_ERRC_API_HDR := $(CUSTOM_ERRC_BITS_SRC_DIR_FULL)/$(CUSTOM_ERRC_API).h
...
CUSTOM_ERRC_ALL_OBJ :=  $(CUSTOM_ERRC_OBJ) \
												$(CUSTOM_ERRC_APPENGINE_ERROR_OBJ) \
												$(CUSTOM_ERRC_RENDERER_ERROR_OBJ) \
												$(CUSTOM_ERRC_API_OBJ)

CUSTOM_ERRC_HEADERS :=  $(CUSTOM_ERRC_APPENGINE_ERROR_HDR) \
												$(CUSTOM_ERRC_RENDERER_ERROR_HDR) \
												$(CUSTOM_ERRC_API_HDR)
...
$(CUSTOM_ERRC_OBJ): $(CUSTOM_ERRC_SRC) $(CUSTOM_ERRC_API_HDR)

$(CUSTOM_ERRC_APPENGINE_ERROR_OBJ) : $(CUSTOM_ERRC_APPENGINE_ERROR_SRC) $(CUSTOM_ERRC_APPENGINE_ERROR_HDR)

$(CUSTOM_ERRC_RENDERER_ERROR_OBJ) : $(CUSTOM_ERRC_RENDERER_ERROR_SRC) $(CUSTOM_ERRC_RENDERER_ERROR_HDR)
